...
function handleTouchStart(e) {
  e.preventDefault(); // タッチを有効にしたままマウスも投げる
  if(noSystemTouch() && !touches.contains(touch.identifier)){
...
function dispatchTouchMouseEvent(evt) {
  ...
  canvasEl.dispatchEvent(evt); // タッチも改めて投げる
  canvasEl.dispatchEvent(newEvt); // マウスも投げる
}
